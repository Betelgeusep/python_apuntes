...
font = pygame.font.SysFont(None, 48) # crea un objeto que represente la fuente predeterminada 
text = font.render("Welcome to pygame", True, (255, 255, 255))# crea un objeto que represente un texto dado, el texto será suavizado (True) y blanco (255,255,255).
